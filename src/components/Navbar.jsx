  ...
  return (
    <nav className="w-full flex xs:h-[90px] md:h-[100px]">
      ...
      <div className="w-full">
        <ul className={`z-[99] slide md:w-full md:h-[67px] md:mt-[33px] flex items-center md:relative xs:fixed md:bg-primary xs:bg-darkPrimary md:flex-row md:justify-end xs:flex-col xs:justify-center xs:w-[70%] xs:h-[100%] md:right-auto ${slide?'xs:right-[-70%]':'xs:right-[0%]'}`}>
