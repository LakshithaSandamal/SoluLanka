  ...
  return (
    <div  id="home" className="bg-transparent w-full absolute xs:mt-[-90px] md:mt-auto xs:h-[100vh] md:h-[calc(100vh-100px)] overflow-hidden">
      ...
      <div className="z-10 absolute">
        <h1 className="text-white xs:text-4xl ss:text-5xl font-bold xs:ml-[20px] ss:ml-[50px] md:mt-[10vh] xs:mt-[20vh]">Lets's Create Your Own <br/> Digital Solution <br/> Today !</h1>
